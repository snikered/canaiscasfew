...
- Encontrados: **320**
- Sem EPG seguro: **2990**
- Canais cuja fonte mudou por consenso: **128**
- Programas gravados: **445588**
...
- **Genius:** 76 canal(is)
- **Open-EPG Brazil 4:** 80 canal(is)
- **EPGShare BR1:** 53 canal(is)
- **IPTV-EPG BR:** 94 canal(is)
- **EPGShare BR2:** 17 canal(is)

## Desempenho da execução

- **Catalogo:** 0.04 s
- **Download E Indexacao Fontes:** 2.68 s
- **Matching Consenso Validacao:** 4.84 s
- **Serializacao E Gzip:** 9.85 s
- **Total até gerar os arquivos principais:** 17.44 s

## Fonte alterada automaticamente por consenso

- **SporTV 1**: Genius → **IPTV-EPG BR** · votos 2/5 · peso 1.5/4.0 · confiança 64%
- **Cartoon Network**: Genius → **EPGShare BR1** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **Combate**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 70%
- **ESPN 2**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 4/4 · peso 3.0/3.0 · confiança 85%
- **ESPN 3**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 4/4 · peso 3.0/3.0 · confiança 85%
- **Premiere 5**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/1.5 · confiança 48%
- **Premiere 6**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/3 · peso 2.0/2.5 · confiança 74%
- **AMC**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 86%
- **SporTV 2**: Genius → **IPTV-EPG BR** · votos 2/5 · peso 2.0/4.0 · confiança 67%
- **Discovery**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 69%
- **Premiere Clubes**: Genius → **IPTV-EPG BR** · votos 2/4 · peso 1.5/3.0 · confiança 63%
- **ESPN 6**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/3 · peso 1.5/2.5 · confiança 63%
- **History**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 81%
- **Animal Planet**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 72%
- **Discovery Kids**: Genius → **EPGShare BR2** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **Discovery Turbo**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 82%
- **ESPN 4**: Open-EPG Brazil 4 → **EPGShare BR2** · votos 4/4 · peso 3.0/3.0 · confiança 86%
- **ESPN 5**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **HGTV**: Genius → **IPTV-EPG BR** · votos 4/4 · peso 3.5/3.5 · confiança 92%
- **Gloob**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **HBO 2**: Genius → **EPGShare BR1** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **History 2**: Genius → **EPGShare BR1** · votos 2/2 · peso 1.5/1.5 · confiança 71%
- **A&E**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 73%
- **Band Sports**: Genius → **IPTV-EPG BR** · votos 1/5 · peso 1.0/4.0 · confiança 44%
- **HBO Family**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **SporTV 3**: Genius → **EPGShare BR1** · votos 2/5 · peso 1.0/4.0 · confiança 54%
- **Universal TV**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 70%
- **AXN**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 73%
- **Band News**: Genius → **Open-EPG Brazil 4** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **CNN Brasil**: Genius → **IPTV-EPG BR** · votos 4/4 · peso 3.5/3.5 · confiança 93%
- **Discovery Science**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 73%
- **HBO Plus**: Genius → **EPGShare BR1** · votos 4/5 · peso 3.0/4.0 · confiança 86%
- **Multishow**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 70%
- **HBO Signature**: Genius → **IPTV-EPG BR** · votos 3/5 · peso 2.5/4.0 · confiança 78%
- **Sony**: Genius → **EPGShare BR1** · votos 2/4 · peso 1.0/3.0 · confiança 55%
- **Space**: Genius → **IPTV-EPG BR** · votos 2/5 · peso 2.0/4.0 · confiança 69%
- **Studio Universal**: Genius → **EPGShare BR1** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **Cartoonito**: Genius → **EPGShare BR1** · votos 2/4 · peso 1.5/3.5 · confiança 64%
- **Cinemax**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **HBO**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 4/4 · peso 3.0/3.0 · confiança 88%
- **TNT Series**: Genius → **EPGShare BR1** · votos 3/5 · peso 2.0/4.0 · confiança 72%
- **WARNER**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 72%
- **Food Network**: Genius → **EPGShare BR1** · votos 2/4 · peso 1.5/3.5 · confiança 65%
- **Discovery Home & Health**: Genius → **EPGShare BR1** · votos 5/5 · peso 4.0/4.0 · confiança 99%
- **ESPN**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 4/4 · peso 3.0/3.0 · confiança 86%
- **Gloobinho**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/3 · peso 1.5/2.5 · confiança 65%
- **GNT**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 72%
- **RedeTV**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 85%
- **Canal Brasil**: Genius → **EPGShare BR2** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **Discovery World**: Genius → **EPGShare BR1** · votos 4/5 · peso 3.0/4.0 · confiança 84%
- **E!**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.5/3.5 · confiança 76%
- **USA Network**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/2.0 · confiança 45%
- **BIS**: Genius → **EPGShare BR2** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **Telecine Action**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 85%
- **Telecine Pipoca**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 85%
- **Telecine Premium**: Genius → **EPGShare BR2** · votos 3/4 · peso 2.0/3.0 · confiança 71%
- **TV Ra Tim Bum**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/3 · peso 1.5/2.5 · confiança 65%
- **OFF**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **TLC**: Genius → **EPGShare BR1** · votos 4/5 · peso 3.0/4.0 · confiança 86%
- **Discovery Theater**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 84%
- **Telecine Cult**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 85%
- **Telecine Fun**: Genius → **Open-EPG Brazil 4** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **Jovem Pan News**: Genius → **Open-EPG Brazil 4** · votos 4/4 · peso 3.5/3.5 · confiança 91%
- **Globo News**: Genius → **EPGShare BR2** · votos 5/5 · peso 4.0/4.0 · confiança 99%
- **Rede Vida**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 85%
- **Arte 1**: Genius → **EPGShare BR1** · votos 2/4 · peso 1.0/3.0 · confiança 55%
- **Film & Arts**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 4/4 · peso 3.0/3.0 · confiança 87%
- **TV Novo Tempo**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/2.0 · confiança 45%
- **WooHoo**: Genius → **EPGShare BR1** · votos 3/4 · peso 2.0/3.0 · confiança 72%
- **Futura**: Genius → **EPGShare BR2** · votos 3/5 · peso 2.0/4.0 · confiança 72%
...
- **FashionTV**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/2 · peso 1.5/1.5 · confiança 70%
- **SBT**: Genius → **EPGShare BR1** · votos 3/3 · peso 2.0/2.0 · confiança 77%
- **Travel Box Brazil**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 3/3 · peso 2.5/2.5 · confiança 81%
- **TV Brasil**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **CNN Brasil Money**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/2 · peso 1.5/1.5 · confiança 66%
- **DISCOVERY ID**: Genius → **IPTV-EPG BR** · votos 1/2 · peso 1.0/2.0 · confiança 44%
- **Music Box Brazil**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/2.0 · confiança 44%
- **Canal Rural**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/1.5 · confiança 48%
- **DOG TV**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/3 · peso 1.0/2.5 · confiança 43%
- **Prime Box Brazil**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/2 · peso 2.0/2.0 · confiança 76%
- **TCM**: Genius → **EPGShare BR1** · votos 3/4 · peso 2.5/3.5 · confiança 77%
...
- **GB NEWS**: Open-EPG Brazil 4 → **EPGShare BR2** · votos 4/4 · peso 3.0/3.0 · confiança 86%
- **GB SP**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/1 · peso 1.0/1.0 · confiança 55%
- **NHK**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/1 · peso 1.0/1.0 · confiança 56%
- **TV CÃ‚MARA**: EPGShare BR1 → **IPTV-EPG BR** · votos 2/2 · peso 1.5/1.5 · confiança 68%
- **BAND**: Genius → **EPGShare BR1** · votos 2/3 · peso 1.0/2.0 · confiança 51%
- **EPTV CAMPINAS**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/1 · peso 1.0/1.0 · confiança 56%
- **Music Box Brasil**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 61%
- **TV TEM SOROCABA**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/1 · peso 1.0/1.0 · confiança 56%
- **TV JUSTICA**: EPGShare BR1 → **EPGShare BR2** · votos 3/3 · peso 2.0/2.0 · confiança 76%
...
- **Prime Box Brasil**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/2 · peso 2.0/2.0 · confiança 75%
- **SBT BRASILIA**: Genius → **IPTV-EPG BR** · votos 2/2 · peso 2.0/2.0 · confiança 77%
- **SONY MOVIES**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/2 · peso 1.5/1.5 · confiança 68%
- **WOHOO**: Genius → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 64%
- **Eurochannel**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 3/3 · peso 2.0/2.0 · confiança 78%
- **JOVEN PAN NEWS**: Genius → **Open-EPG Brazil 4** · votos 4/4 · peso 3.5/3.5 · confiança 90%
- **PREMIERE 9**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/2 · peso 2.0/2.0 · confiança 78%
...
- **WARNER TV**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 2/3 · peso 1.0/2.0 · confiança 55%
- **Discovery Theather**: Genius → **IPTV-EPG BR** · votos 4/5 · peso 3.0/4.0 · confiança 83%
- **REDE BRASIL TV**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 3/3 · peso 2.5/2.5 · confiança 82%
- **Telecine Action [LEG]**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.5/3.5 · confiança 78%
- **Telecine Pipoca [LEG]**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.5/3.5 · confiança 78%
- **Telecine Premium [LEG]**: Genius → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 63%
- **TV GLOOBINHO**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/2.0 · confiança 44%
- **ZOOMOO KIDS**: EPGShare BR1 → **IPTV-EPG BR** · votos 1/2 · peso 1.0/1.5 · confiança 46%
- **GLOBO NEWS DF**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 3/3 · peso 2.5/2.5 · confiança 82%
- **MTV Live**: EPGShare BR1 → **IPTV-EPG BR** · votos 1/1 · peso 1.0/1.0 · confiança 56%
- **POLISHOP**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 1/1 · peso 0.5/0.5 · confiança 52%
- **PREMIERE CLUB**: Genius → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 63%
- **TVE BRASIL>>>**: Genius → **IPTV-EPG BR** · votos 3/4 · peso 2.5/3.5 · confiança 75%
...
- **CNT**: Open-EPG Brazil 4 → **IPTV-EPG BR** · votos 2/2 · peso 2.0/2.0 · confiança 78%
...
- **PREMIERE CLUBES BR***: Genius → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 63%
- **PT CARTOON NETWORK**: Genius → **IPTV-EPG BR** · votos 2/3 · peso 1.5/2.5 · confiança 63%
- **REDE BRASIL**: Open-EPG Brazil 4 → **EPGShare BR1** · votos 3/3 · peso 2.5/2.5 · confiança 83%
...
- **Prime Box Brasil** → `PrimeBoxBrazil.br` em IPTV-EPG BR (aproximação 0.929: PRIMEBOXBRASIL ~ PRIMEBOXBRAZIL)
...
- **CNN INTERNACIONAL** → `São.Paulo/SP..CNN.International.br` em EPGShare BR1 (aproximação 0.938: CNNINTERNACIONAL ~ CNNINTERNATIONAL)
...
- **JOVEN PAN NEWS** → `Jovem Pan News.br` em Open-EPG Brazil 4 (aproximação 0.917: JOVENPANNEWS ~ JOVEMPANNEWS)
...
- **Discovery Theather** → `DiscoveryTheater.br` em IPTV-EPG BR (aproximação 0.970: DISCOVERYTHEATHER ~ DISCOVERYTHEATER)
...
- **REDE BRASIL TV** → `Rede.Brasil.HD.br` em EPGShare BR1 (aproximação 0.909: REDEBRASILTV ~ REDEBRASIL)
...
- **Telecine Action [LEG]** → `TelecineAction.br` em IPTV-EPG BR (aproximação 0.903: TELECINEACTIONLEG ~ TELECINEACTION)
- **Telecine Pipoca [LEG]** → `TelecinePipoca.br` em IPTV-EPG BR (aproximação 0.903: TELECINEPIPOCALEG ~ TELECINEPIPOCA)
- **Telecine Premium [LEG]** → `TelecinePremium.br` em IPTV-EPG BR (aproximação 0.909: TELECINEPREMIUMLEG ~ TELECINEPREMIUM)
- **TV GLOOBINHO** → `Gloobinho.br` em IPTV-EPG BR (aproximação 0.900: TVGLOOBINHO ~ GLOOBINHO)
...
- **GLOBO NEWS DF** → `GloboNews.br` em IPTV-EPG BR (aproximação 0.900: GLOBONEWSDF ~ GLOBONEWS)
- **GLOBO TV VANGUARDA S J CAMPOS** → `4030` em Genius (aproximação 0.941: GLOBOTVVANGUARDASJCAMPOS ~ GLOBOTVVANGUARDASJDOSCAMPOS)
- **PREMIERE CLUB** → `PremiereClubes.br` em IPTV-EPG BR (aproximação 0.923: PREMIERECLUB ~ PREMIERECLUBES)
...
- **PREMIERE CLUBES BR*** → `PremiereClubes.br` em IPTV-EPG BR (aproximação 0.933: PREMIERECLUBESBR ~ PREMIERECLUBES)
- **PT CARTOON NETWORK** → `CartoonNetwork.br` em IPTV-EPG BR (aproximação 0.933: PTCARTOONNETWORK ~ CARTOONNETWORK)
- **PT DISCOVERY** → `4179` em Genius (aproximação 0.900: PTDISCOVERY ~ DISCOVERY)
